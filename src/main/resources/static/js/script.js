...
function readURL(input){if(input.files&&input.files[0]){var reader=new FileReader();reader.onload=function(e){$('#blah').attr('th:src',e.target.result);}
...
'<img th:src="/img/icons/siderbar-icon2.svg" class="feather-five" alt="">'+
...
'<img th:src="/img/logo.png" alt="Logo" class="img-flex">'+
'</a>'+
'</div>'+
'</div>'+
'<div class="col-xl-6 col-sm-6 col-12">'+
'<a class="btn-closed" th:href="@{javascript:void(0)}"><img class="img-fliud" th:src="/img/icons/sidebar-delete-icon.svg" alt="demo"></a>'+
'</div>'+
'</div>'+
'</div>'+
'</div>'+
...
'<img class="img-fliud" th:src="/img/demo-one.png" alt="demo">'+
'</div>'+
'<div class="row">'+
